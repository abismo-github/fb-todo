...
const Header = ({ fbName, fbEmail, fbUid, setFBName, setFBEmail, setFBUid }) => {
  ...
  return (
    <header className="p-7 bg-black">
      <div className="flex items-center justify-between">
        ...
        <ul className="flex items-center justify-center gap-4 hover:text-orange-600">
          <li>
          ...
          <li>
            <Link to={fbUid ? "/todo" : "/login"}  className="text-white hover:text-orange-600">
              Todo
            </Link>
          </li>
          <li>
